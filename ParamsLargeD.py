...
dt = 0.0004       #timestep for physics
...
initial_position = np.array([[xt+rd,yt+rd],[xt+rd,yt]]) #initial positions of particles
...
D = 2*2.30E-9                          #diffusion coefficient of solute. This number is the self-diffusion coeff of water at 25 C.
